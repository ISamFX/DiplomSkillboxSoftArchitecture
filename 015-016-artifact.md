...
### Cписок специалистов необходимых для создания и сопровождения MVP, а также поддерживать его функциональность и производительность на высоком уровне.
...
**Общий объем данных на месяц:** 49.5 МБ + 10.3 ГБ + 719 МБ + 4.75 ГБ + 44 МБ ≈ **15.7  ГБ**
...
- **Стоимость оборудования для развертывания MVP** от **$18,000 ежемесячно** (12 мес).
- **Стоимость оборудования** для развертывания сервисов **последующих этапов** разработки приложения **$32,400 ежемесячно** (10 месяцев).
...
| Kafka Connect                                      | Виртуальный | 2   | 4        | 20                 | 4                      | 8 CPU, 16 ГБ, 80 ГБ      |
| PostgreSQL                                         | Виртуальный | 4   | 8        | 100                 | 5                      | 20 CPU, 40 ГБ, 500 ГБ    |
...
| Сервис оповещений                                 | Виртуальный | 2   | 4        | 20                 | 4                      | 8 CPU, 16 ГБ, 80 ГБ      |
...
Останется неизменной cтоимость годового сопровождения группой IT-специалистов от $127,200 до $177,000 (12 месяцев). 

Годовые затраты на оборудование для развертывания приложения увеличатся в 2 раза и составят $1,080,000 (изначально $540,000).

Итого: **стоимость владения системой в год от $1,207,200 до $1,257,000**.
